...
import { Currency, Percent, Token } from '@real-wagmi/sdk';
import { MintSpecificOptions, IncreaseSpecificOptions, NonfungiblePositionManager, Position } from '@real-wagmi/v3-sdk';
...
export abstract class ApproveAndCall {
     ...
     */
    public static encodeAddLiquidity(position: Position, minimalPosition: Position, addLiquidityOptions: CondensedAddLiquidityOptions, slippageTolerance: Percent): Hex {
