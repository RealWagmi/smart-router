import { BigintIsh, Currency, CurrencyAmount, TradeType, ZERO, ChainId } from '@real-wagmi/sdk';
...
async function getBestRoutes(amount: CurrencyAmount<Currency>, currency: Currency, tradeType: TradeType, routeConfig: RouteConfig): Promise<BestRoutes | null> {
