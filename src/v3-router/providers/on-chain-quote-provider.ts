...
import { WagmiMulticallProvider } from './multicall-swap-provider'
    ...
    const createGetRoutesWithQuotes = (isExactIn = true) => {
      ...
      return async function getRoutesWithQuote(
        ...
        const multicallConfigs =
          ...
          BATCH_MULTICALL_CONFIGS[ChainId.ZK_SYNC]
        ...
        const multicall2Provider = new WagmiMulticallProvider(chainId, chainProvider, gasLimitOverride)
