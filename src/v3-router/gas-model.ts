...
import { GasCost, GasEstimateRequiredInfo, GasModel, Pool, PoolProvider, PoolType, RouteWithoutGasEstimate } from './types';
...
export async function createGasModel({ gasPriceWei, poolProvider, quoteCurrency, blockNumber }: GasModelConfig): Promise<GasModel> {
