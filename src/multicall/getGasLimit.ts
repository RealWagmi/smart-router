import { BigintIsh, ChainId } from '@real-wagmi/sdk';
import { toBigInt } from '../utils/toBigInt';
import { PublicClient } from 'viem';

import { DEFAULT_GAS_BUFFER, DEFAULT_GAS_BUFFER_BY_CHAIN, DEFAULT_GAS_LIMIT, DEFAULT_GAS_LIMIT_BY_CHAIN } from './constants';
